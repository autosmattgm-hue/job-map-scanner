...
export function signAccessToken(user) {
  ...
  return signJwt({
    ...
    subscription: entitled.subscription || "starter",
    billingStatus: entitled.billingStatus || "active",
...
export async function verifyAccessToken(token) {
  ...
  return applyAdminEntitlements({
    ...
    subscription: decoded.subscription || "starter",
    billingStatus: decoded.billingStatus || "active",
